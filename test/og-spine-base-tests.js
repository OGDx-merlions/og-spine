...
function runBaseTests() {
  og_spine_1 = document.getElementById('og_spine_1');

  suite('Base Automation Tests for og-spine', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-spine fixture is created', function() {
      assert.isTrue(document.getElementById('og_spine_1') !== null);
    });
